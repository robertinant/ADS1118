...
#define LCD_CS_LOW 		digitalWrite(13, LOW);	//set CS low
#define LCD_CS_HIGH 	digitalWrite(13, HIGH);	//set CS high
#define LCD_RS_LOW 		digitalWrite(12, LOW);	//set RS low
#define LCD_RS_HIGH 	digitalWrite(12, HIGH);	//set RS high
#define LCD_RST_LOW 	digitalWrite(11, LOW);	//set RST low
#define LCD_RST_HIGH 	digitalWrite(11, HIGH);
